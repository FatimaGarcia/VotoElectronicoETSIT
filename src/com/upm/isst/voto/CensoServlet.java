...
public class CensoServlet extends HttpServlet {
	...
	public void init(){
		...
		dao1.create((long) 8, "Mar�a Teresa Garc�a Arce", "albacete", "C's", 3);
		dao1.create((long) 9, "Laureano Garc�a Palomares", "albacete", "C's", 3);
		...
		dao1.create((long) 29, "Antonio Jos� Pezzi Acosta", "madrid", "C's", 3);
