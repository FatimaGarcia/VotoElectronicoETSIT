...
public class CensoServlet extends HttpServlet {
	...
	public void init(){
		...
		dao1.create((long) 8, "María Teresa García Arce", "albacete", "C's", 3);
		dao1.create((long) 9, "Laureano García Palomares", "albacete", "C's", 3);
		dao1.create((long) 10, "Juan Miguel González Sánchez", "albacete", "Podemos", 4);
		...
		dao1.create((long) 29, "Antonio José Pezzi Acosta", "madrid", "C's", 3);
